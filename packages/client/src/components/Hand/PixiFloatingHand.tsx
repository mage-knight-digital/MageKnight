...
export function PixiFloatingHand({
  ...
  }, [isAppReady, viewMode, findCardAtPosition, visibleHand, getOriginalIndex, playableCards, cardWidth, cardHeight, onCardClick, isOverlayActive, inCombat, setVisualScale]);
