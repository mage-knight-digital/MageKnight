...
const SPRITE_SHEETS = {
  basic_actions: {
    url: "/assets/cards/basic_actions.jpg",
    spriteWidth: 1000,
    spriteHeight: 1400,
    cols: 7,
    rows: 4,
  ...
  advanced_actions: {
    url: "/assets/cards/advanced_actions.jpg",
    spriteWidth: 1000,
    spriteHeight: 1400,
    cols: 8,
    rows: 6,
  ...
  artifacts: {
    url: "/assets/cards/artifacts.jpg",
    spriteWidth: 1000,
    spriteHeight: 1400,
    cols: 5,
    rows: 5,
  ...
  units_regular: {
    url: "/assets/units/units_regular.jpg",
    spriteWidth: 1000,
    spriteHeight: 1400,
    cols: 4,
    rows: 4,
  ...
  units_elite: {
    url: "/assets/units/units_elite.jpg",
    spriteWidth: 1000,
    spriteHeight: 1400,
    cols: 4,
    rows: 4,
  ...
  tactics: {
    url: "/assets/tactics/tactics_spritesheet.jpg",
    spriteWidth: 1000,
    spriteHeight: 1400,
    cols: 6,
    rows: 2,
