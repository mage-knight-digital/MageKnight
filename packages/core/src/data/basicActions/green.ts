...
import {
  CATEGORY_MOVEMENT, CATEGORY_HEALING, CATEGORY_SPECIAL, DEED_CARD_TYPE_BASIC_ACTION,
} from "../../types/cards.js";
import {
...
export const MARCH: DeedCard = {
  ...
  poweredBy: [MANA_GREEN], categories: [CATEGORY_MOVEMENT],
...
export const TRANQUILITY: DeedCard = {
  ...
  poweredBy: [MANA_GREEN], categories: [CATEGORY_HEALING],
...
export const CONCENTRATION: DeedCard = {
  ...
  poweredBy: [MANA_GREEN], categories: [CATEGORY_SPECIAL],
...
export const KRANG_SAVAGE_HARVESTING: DeedCard = {
  ...
  poweredBy: [MANA_GREEN], categories: [CATEGORY_MOVEMENT, CATEGORY_SPECIAL],
  basicEffect: move(2), poweredEffect: move(4), sidewaysValue: 1,
};
