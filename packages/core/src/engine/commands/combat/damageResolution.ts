/**
 * Damage resolution helpers for combat phase transitions
 *
 * Handles resolving pending damage against enemies, clearing combat state,
 * and applying fame/reputation changes from defeated enemies.
 */
