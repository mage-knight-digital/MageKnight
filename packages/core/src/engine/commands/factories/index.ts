...
export {
  ...
  createResolveDiscardForBonusCommandFromAction,
...
export {
  ...
  createDeclinePlunderCommandFromAction,
...
export const commandFactoryRegistry: Record<string, CommandFactory> = {
  ...
  [RESOLVE_DISCARD_FOR_BONUS_ACTION]: createResolveDiscardForBonusCommandFromAction,
  ...
  [DECLINE_PLUNDER_ACTION]: createDeclinePlunderCommandFromAction,
