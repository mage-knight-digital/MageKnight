...
const resolvabilityHandlers: Partial<Record<EffectType, ResolvabilityHandler>> = {
  ...
  [EFFECT_GAIN_ATTACK]: (state) => state.combat !== null,
  [EFFECT_GAIN_ATTACK_BOW_RESOLVED]: (state) => state.combat !== null,
  [EFFECT_GAIN_BLOCK]: (state) => state.combat !== null,
  [EFFECT_TERRAIN_BASED_BLOCK]: (state) => state.combat !== null,
