/**
 * Tests for Green Crystal Craft skill (Goldyx)
 *
...
import { SKILL_GOLDYX_GREEN_CRYSTAL_CRAFT } from "../../data/skills/index.js";
import { getValidActions } from "../validActions/index.js";

describe("Green Crystal Craft skill", () => {
  ...
  describe("activation", () => {
    it("should grant blue crystal and green mana token", () => {
      const player = createTestPlayer({
        hero: Hero.Goldyx,
        skills: [SKILL_GOLDYX_GREEN_CRYSTAL_CRAFT],
        skillCooldowns: {
          usedThisRound: [],
          usedThisTurn: [],
          usedThisCombat: [],
      ...
      const result = engine.processAction(state, "player1", {
        ...
        skillId: SKILL_GOLDYX_GREEN_CRYSTAL_CRAFT,
      });
    ...
    it("should add skill to usedThisRound cooldown", () => {
      ...
      ).toContain(SKILL_GOLDYX_GREEN_CRYSTAL_CRAFT);
    });
    ...
    it("should reject if skill already used this round", () => {
      const player = createTestPlayer({
        ...
        skills: [SKILL_GOLDYX_GREEN_CRYSTAL_CRAFT],
        skillCooldowns: {
          usedThisRound: [SKILL_GOLDYX_GREEN_CRYSTAL_CRAFT],
          usedThisTurn: [],
          usedThisCombat: [],
          activeUntilNextTurn: [],
        },
  ...
  describe("crystal limit", () => {
    it("should only grant mana token when at 3 blue crystals", () => {
      ...
      // Overflow: blue crystal overflows to blue mana token + green mana token from skill
  ...
  describe("undo", () => {
    it("should be undoable after activation", () => {
      ...
      ).not.toContain(SKILL_GOLDYX_GREEN_CRYSTAL_CRAFT);
