/**
 * Tests for Cold Swordsmanship skill (Tovak)
 *
 * Skill effect: Attack 2 or Ice Attack 2.
...
import { SKILL_TOVAK_COLD_SWORDSMANSHIP } from "../../data/skills/index.js";
...
describe("Cold Swordsmanship skill", () => {
  ...
  describe("activation", () => {
    it("should activate during attack phase", () => {
      const player = createTestPlayer({
        hero: Hero.Tovak,
        skills: [SKILL_TOVAK_COLD_SWORDSMANSHIP],
        skillCooldowns: {
          usedThisRound: [],
          usedThisTurn: [],
          usedThisCombat: [],
      ...
      const result = engine.processAction(state, "player1", {
        ...
        skillId: SKILL_TOVAK_COLD_SWORDSMANSHIP,
      });
  ...
  describe("attack options", () => {
    ...
    it("should grant Ice Attack 2 when choosing ice option", () => {
      const player = createTestPlayer({
        hero: Hero.Tovak,
        skills: [SKILL_TOVAK_COLD_SWORDSMANSHIP],
        skillCooldowns: {
      ...
      const updatedPlayer = afterChoice.state.players[0];
      expect(
        updatedPlayer.combatAccumulator.attack.normalElements[ELEMENT_ICE]
      ).toBe(2);
    });
  });
