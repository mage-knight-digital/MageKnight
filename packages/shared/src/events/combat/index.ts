...
import { ENEMY_BLOCKED, BLOCK_FAILED, BLOCK_ASSIGNED, BLOCK_UNASSIGNED, MOVE_SPENT_ON_CUMBERSOME, HEROES_ASSAULT_INFLUENCE_PAID, THUGS_DAMAGE_INFLUENCE_PAID, INFLUENCE_CONVERTED_TO_BLOCK } from "./blocking.js";
import { ENEMY_DEFEATED, ATTACK_FAILED, ATTACK_ASSIGNED, ATTACK_UNASSIGNED, MOVE_CONVERTED_TO_ATTACK } from "./attacks.js";
import {
  DAMAGE_ASSIGNED,
  COMBAT_ENDED,
  COMBAT_EXITED,
