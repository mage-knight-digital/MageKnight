...
_ACTION_TYPE_IDS: tuple[str, ...] = (
    ...
    "DECLARE_ATTACK", "DECLARE_ATTACK_TARGETS", "DECLARE_BLOCK", "DECLARE_REST",
    "DISBAND_UNIT", "END_COMBAT_PHASE", "END_TURN",
    "ENTER_COMBAT", "ENTER_SITE", "EXPLORE", "FINALIZE_ATTACK", "INTERACT",
...
_SOURCE_IDS: tuple[str, ...] = (
    ...
    "combat.declare_targets", "combat.end_phase",
    "combat.finalize_attack", "combat.heroes_assault_payment",
