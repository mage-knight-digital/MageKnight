...
variable "app_origin_ipv4" {
  description = "IPv4 origin for play.mageknightdigital.app. Leave null until the app server exists."
  type        = string
  default     = null
}

variable "api_origin_ipv4" {
  description = "IPv4 origin for api.mageknightdigital.app. Leave null until the app server exists."
  type        = string
  default     = null
}
